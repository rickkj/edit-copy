...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Copy images from clipboard directly to DaVinci Resolve timeline." },
      { name: "author", content: "EditCOPY" },
      ...
      { name: "twitter:site", content: "@EditCOPY" },
    ],
    links: [
      {
        rel: "stylesheet",
